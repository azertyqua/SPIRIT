...
exports.run = (bot, msg, args) => {
    if (args.length < 1) {
        throw 'S\'il vous plaît fournir une couleur !';
    }

    if (!/^#?([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$/.test(args[0])) {
        throw 'La couleur doit être au format `#RRGGBB` ou `#RGB`!';
    }
...
exports.info = {
    name: 'color',
    usage: 'color <hex>',
    description: 'Affiche des informations et un aperçu d\'une couleur hexadécimale'
};
