...
class TodoList {
    ...
    _validateIndex(index) {
        ...
        if (index < 0 || index > this.items.length) {
            throw 'Veuillez spécifier un nombre valide!';
        }
...
module.exports.info = {
    ...
    description: 'Gérer une liste de tâches. La commande en elle-même affichera les éléments de la liste actuelle.',
    options: [
        {
            name: '-c',
            usage: '-c ',
            description: 'Marquer un élément complet'
        },
        {
            name: '-i',
            usage: '-i ',
            description: 'Marquer un élément incomplet'
        },
        {
            name: '-d',
            usage: '-d',
        ...
        },
        {
            name: '-l',
            usage: '-l',
            description: 'Afficher toutes les listes'
        },
        {
            name: '-n',
            usage: '-n ',
            description: 'Faire une nouvelle liste et la définir comme la liste actuelle'
        },
        {
            name: '-r',
            usage: '-r ',
            description: 'Supprimer une liste Si la liste en cours de suppression est la liste actuellement utilisée, revient automatiquement à la liste principale.'
        },
        {
            name: '-s',
            usage: '-s ',
            description: 'Changer de liste'
        }
    ]
};
